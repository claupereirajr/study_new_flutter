...
mixin _$User {
  ...
  TResult when<TResult extends Object?>(
    TResult Function(int id, String name, String email, String password)
        $default, {
    required TResult Function() notLogged,
    required TResult Function(int id, String name, String email,
            String password, String token, String refreshToken)
        logged,
  }) =>
...
class _$UserImpl implements _User {
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(id, name, email, password);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(id, name, email, password);
  }
...
class _$LoggedUserImpl implements LoggedUser {
  ...
  @override
  String toString() {
    return 'User.logged(id: $id, name: $name, email: $email, password: $password, token: $token, refreshToken: $refreshToken)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, name, email, password, token, refreshToken);
  ...
  TResult when<TResult extends Object?>(
    ...
    return logged(id, name, email, password, token, refreshToken);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return logged?.call(id, name, email, password, token, refreshToken);
  }
